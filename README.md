...
B.Tech CSE · KL University Hyderabad, Class of 2028 · ML + systems focus
...
**ML** · PyTorch · TensorFlow · Scikit-learn · EfficientNet · MobileNet · ChromaDB · Ollama

**Backend** · FastAPI · Flask · Spring Boot · NestJS · SQLAlchemy · Redis

**Frontend** · Next.js · React · React Native · Tailwind CSS · Vite

**Infra** · Docker · GitHub Actions · AWS (ECS, ECR) · Kubernetes · Keycloak · Supabase
